...
const GameCard = ({ game }) => {
  return (
    <div class="w-full rounded-xl justify-between shadow-lg flex flex-col border border-slate-700">
      <img
      ...
      <div class="px-6 py-4">
        ...
        <p class="text-slate-700 text-base">{game.description}</p>
      </div>
      <div class="px-6 py-4">
        <span class="inline-block bg-custom-gradient rounded-full px-3 py-1 text-sm font-semibold text-slate-700 mr-2">
          {game.category}
        </span>
      </div>
